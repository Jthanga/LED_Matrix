...
fclose(column[3]);
 ...
 for(j=0; j<8; j++){	 
	transfer(fd, (unsigned char*) (LedMatrixRows+j),&null,1);
	
     transfer(fd, (unsigned char*) (CNumber1+j), &null, 1);
 ...
 for(j=0; j<8; j++){	 
	transfer(fd, (unsigned char*) (LedMatrixRows+j), &null, 1);
     transfer(fd, (unsigned char*) (CNumber2+j), &null, 1);	
        usleep(1500);       //sleep for 1s each loop
      }
  }
 };
 ...
 for(j=0; j<8; j++){	 
	transfer(fd, (unsigned char*) (LedMatrixRows+j), &null, 1);
     transfer(fd, (unsigned char*) (CNumber3+j), &null, 1);	
        usleep(1500);       //sleep for 1s each loop
      }
  }
 };
 ...
 for(j=0; j<8; j++){	 
	transfer(fd, (unsigned char*) (LedMatrixRows+j), &null, 1);
     transfer(fd, (unsigned char*) (CNumber4+j), &null, 1);	
        usleep(1500);       //sleep for 1s each loop
      }
  }
 ...
 for(j=0; j<8; j++){	 
	transfer(fd, (unsigned char*) (LedMatrixRows+j), &null, 1);
     transfer(fd, (unsigned char*) (CNumber5+j), &null, 1);	
        usleep(1500);       //sleep for 1s each loop
      }
  }
 };
 ...
 for(j=0; j<8; j++){	 
	transfer(fd, (unsigned char*) (LedMatrixRows+j), &null, 1);
     transfer(fd, (unsigned char*) (CNumber6+j), &null, 1);	
        usleep(1500);       //sleep for 1s each loop
      }
  }
 };
 ...
 for(j=0; j<8; j++){	 
	transfer(fd, (unsigned char*) (LedMatrixRows+j), &null, 1);
     transfer(fd, (unsigned char*) (CNumber7+j), &null, 1);	
        usleep(1500);       //sleep for 1s each loop
      }
  }
 };
 ...
 for(j=0; j<8; j++){	 
	transfer(fd, (unsigned char*) (LedMatrixRows+j), &null, 1);
     transfer(fd, (unsigned char*) (CNumber8+j), &null, 1);	
        usleep(1500);       //sleep for 1s each loop
      }
  }
 };
 ...
 for(j=0; j<8; j++){	 
	transfer(fd, (unsigned char*) (LedMatrixRows+j), &null, 1);
     transfer(fd, (unsigned char*) (CNumber0+j), &null, 1);	
        usleep(1500);       //sleep for 1s each loop
      }
  }
 };
